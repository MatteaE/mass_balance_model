...
run_params <- list(
  ...
  filename_massbalance_annual  =   "mb_abramov.dat",       # File name of the annual mass balance observations
  filename_massbalance_winter  =   "mb_abramov_winter.dat",                           # File name of the winter mass balance observations
  ...
  default_temp_elegrad         =   -0.8,                         # [°C / 100 m]: default altitudinal gradient of air temperature.
  ...
  first_year                   =   1987,                         # First modeled year (usually from October of the previous year to September of this year)
