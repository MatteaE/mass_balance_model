...
\begin{titlepage}
	...
	\vspace{0.6 cm}
	{\normalsize October 2021, updated September 2026}
...
\begin{itemize}
    ...
    \item (Only if you use the Windows operating system) \textbf{Download and install RTools.} Go to \href{https://cran.r-project.org/bin/windows/Rtools/}{this page} and download the latest RTools installer. Open the installer and proceed until RTools is installed.
