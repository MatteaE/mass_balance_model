...
func_plot_write_overview <- function(overview_annual,
  ...
  overview_annual$summary_df_out <- data.frame(year = overview_annual$summary_df$year,
                                               ...
                                               sprintf(overview_annual$summary_df$rmse_unweighted, fmt=run_params$output_fmt1),
                                               sprintf(overview_annual$summary_df$loo_rmse_unweighted, fmt=run_params$output_fmt1),
                                               sprintf(overview_annual$summary_df$winter_rmse, fmt=run_params$output_fmt1),
                                               sprintf(overview_annual$summary_df$winter_rmse_unweighted, fmt=run_params$output_fmt1),
