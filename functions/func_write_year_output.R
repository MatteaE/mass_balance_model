...
func_write_year_output <- function(year_data,
  ...
  df_annual_daily <- data.frame(date                = model_annual_dates,
                                ...
                                gl_massbal_bandcorr = sprintf("%.1f", year_data$mod_output_annual_cur$gl_massbal_cumul_bandcorr),
                                ...
                                gl_melt_bandcorr    = sprintf("%.1f", year_data$mod_output_annual_cur$gl_melt_cumul_bandcorr))
